  ...
  return (
    <div className="py-10 bg-[#f8f7f4]">
      ...
      <motion.div
        ...
        variants={fadeUp}
      >
        <h1 className="font-bold text-[#5b4f47]">Shop Our Best Seller</h1>
      ...
      {/* Products Grid */}
      <div className="md:ml-32 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-4">
